...
(define cave-goblin-slinger   (mk-npct2 "Æ¶·¢¥´¥Ö¥ê¥ó¤ÎÅêÀÐÊ¼"  sp_cave_goblin  oc_warrior s_cgob_slinger    basic-traps  slinger-equip    nil 'generic-ai faction-cave-goblin  nil 'drop-generic slinger-loot))
(define cave-goblin-berserker (mk-npct2 "Æ¶·¢¥´¥Ö¥ê¥ó¤Î¶¸Àï»Î"  sp_cave_goblin  oc_warrior s_cgob_berserk    basic-traps  berserker-equip  nil 'generic-ai faction-cave-goblin  nil 'drop-generic berserker-loot))
(define cave-goblin-priest    (mk-npct2 "Æ¶·¢¥´¥Ö¥ê¥ó¤ÎÁÎÎ·"    sp_cave_goblin  oc_wizard  s_cgob_shaman    wizard-traps wizard-equip     nil 'priest-ai  faction-cave-goblin  nil 'drop-generic wizard-loot))
...
(define skeletal-spear-thrower (mk-npct2 "³¼¹ü¤ÎÁäÅê¤²" sp_skeleton oc_warrior s_spearskeleton basic-traps spear-thrower-equip    undead-effects 'nolight-ai faction-monster nil 'drop-generic spear-thrower-loot))
...
(define craven-archer (mk-npct2 "¶²ÉÝ¤Î¼Í¼ê"    sp_skeleton oc_warrior s_deatharcher   basic-traps craven-archer-equip nil            'craven-archer-ai faction-monster nil 'drop-generic cra-arch-loot))

(define halberdier    (mk-npct2 "ÉàÁäÊ¼"        sp_human    oc_warrior s_guard        no-traps halberdier-equip   nil 'guard-ai faction-men   nil 'drop-generic halberdier-loot))
...
(define glasdrin-halberdier    (mk-npct2 "ÉàÁäÊ¼"        sp_human    oc_warrior s_guard        no-traps halberdier-equip   nil 'guard-ai faction-glasdrin   nil 'drop-generic halberdier-loot))
...
;; Bandit types
(define footpad    (mk-npct2 "ÄÉ¤¤¤Ï¤®"   sp_human oc_wrogue s_brigand wrogue-traps wrogue-1-equip nil 'std-ai faction-outlaw nil 'drop-generic wrogue-1-loot))
(define bandit     (mk-npct2 "ÅðÂ±"       sp_human oc_wrogue s_brigand wrogue-traps wrogue-2-equip nil 'std-ai faction-outlaw nil 'drop-generic wrogue-2-loot))
...
(define dragon (mk-npct2 "Îµ" sp_dragon nil s_dragon wizard-traps nil drag-effects 'dragon-ai faction-monster nil 'drop-generic dragon-loot))
...
(define corrupt-halberdier (mk-npct2 "ÉàÁäÊ¼" sp_human oc_warrior s_guard no-traps halberdier-equip nil 'guard-ai faction-monster nil 'drop-generic halberdier-loot))
...
(define giant-spider (mk-npct2 "µðÂç¥°¥â" sp_spider nil s_spider nil nil nil 'spider-ai faction-monster nil 'drop-generic spider-loot))
...
(define ratling-sorcerer (mk-npct2 "¥Í¥º¥ß¿Í´Ö¤ÎÍÅ½Ñ»Õ"  sp_ratling oc_wizard s_ratling_sorcerer wizard-traps wizard-equip  nil 'ratling-sorcerer-ai faction-monster nil 'drop-generic animal-loot))
...
(define green-slime     (mk-npct "ÎÐ¿§¤ÎÇ´¶Ý"             sp_green_slime   nil        s_slime        nil          nil           slime-effects 'animal-ai       faction-monster       nil))
...
(define wolf            (mk-npct "Ïµ"                     sp_wolf          nil        s_wolf         nil          nil           nil           'wolf-ai       faction-monster       nil))
(define wisp            (mk-npct "¤¿¤Ê¤Ó¤¯¸÷"             sp_wisp          nil        s_wisp         nil          nil           wisp-effects  'wisp-ai         faction-monster       nil))
(define nixie-spearman  (mk-npct "¥Ë¥­¥·¡¼¤ÎÁäÊ¼"         sp_nixie         oc_warrior s_nixie_spear  no-traps     nixie-1-equip nil           'nixie-ai        faction-monster       nil))
...
(define accursed-adept      (mk-npct2 "¼ö¤ï¤ì¤¿¾åµéÆ³»Õ"       sp_human oc_wizard s_wizard   nil accursed-3-equip nil 'spell-sword-ai faction-accursed nil 'drop-generic wizard-loot))
...
(define accursed-defender   (mk-npct2 "¼ö¤ï¤ì¤¿ËÉ±Ò¼Ô"         sp_human oc_warrior s_knight  nil accursed-5-equip nil 'std-ai         faction-accursed nil 'drop-generic accursed-5-loot))
(define accursed-templar    (mk-npct2 "¼ö¤ï¤ì¤¿¿ÀÅÂµ³»Î"       sp_human oc_warrior s_avatar  nil accursed-6-equip nil 'std-ai         faction-accursed nil 'drop-generic wrogue-4-loot))
...
(define cave-goblin-slinger-m   (mk-npct2 "Æ¶·¢¥´¥Ö¥ê¥ó¤ÎÅêÀÐÊ¼" sp_cave_goblin  oc_warrior s_cgob_slinger    basic-traps  slinger-equip    nil 'generic-ai faction-monster  nil 'drop-generic slinger-loot))
(define cave-goblin-berserker-m (mk-npct2 "Æ¶·¢¥´¥Ö¥ê¥ó¤Î¶¸Àï»Î" sp_cave_goblin  oc_warrior s_cgob_berserk    basic-traps  berserker-equip  nil 'generic-ai faction-monster  nil 'drop-generic berserker-loot))
