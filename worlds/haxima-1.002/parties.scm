...
(define forest-goblin-party-l2
  (ptype-mk "¥´¥Ö¥ê¥ó¤ÎÄå»¡Ââ" s_fgob_archer faction-forest-goblin 2 2
            (pgroup-mk 'forest-goblin-stalker "1")
...
(define forest-goblin-party-l4 
  (ptype-mk "¥´¥Ö¥ê¥ó¤Î°ìÂ²"  s_fgob_civilian faction-forest-goblin 4 2
            (pgroup-mk 'forest-goblin-stalker "1d2")
            (pgroup-mk 'forest-goblin-hunter  "1d2")
            (pgroup-mk 'wolf "1d2")
...
(define bandit-party-l1
  (ptype-mk "ÄÉ¤¤¤Ï¤®¤Î½¸ÃÄ" s_brigand faction-outlaw 1 4
            (pgroup-mk 'footpad "1d2")
            ))
(define bandit-party-l2
  (ptype-mk "ÅðÂ±ÃÄ" s_brigand faction-outlaw 2 4
...
(define dryad-party-l4
  (ptype-mk "ÌÚ¤ÎÀº¤ÈÏµ" s_reaper faction-monster 4 5
            (pgroup-mk 'dryad "1")
            (pgroup-mk 'wolf "1d3")
            ))
...
(define wolf-party-l1 
  (ptype-mk "Ïµ¤Î·²¤ì" s_wolf faction-monster 2 5
            (pgroup-mk 'wolf "1")
            ))
...
(define skeleton-party-l2
  (ptype-mk "³¼¹ü¤ÎÎ¹ÃÄ" s_skeleton faction-monster 2 5
            (pgroup-mk 'skeletal-warrior "1")
            ))

(define skeleton-party-l3
  (ptype-mk "³¼¹ü¤ÎÎ¹ÃÄ" s_skeleton faction-monster 3 5
            (pgroup-mk 'skeletal-warrior "1")
            (pgroup-mk 'skeletal-spear-thrower "1")
            ))
(define skeleton-party-l4 
  (ptype-mk "³¼¹ü¤ÎÎ¹ÃÄ" s_skeleton faction-monster 4 5
...
(define dragon-party-l6
  (ptype-mk "¸ÉÎ©¤·¤¿Îµ" s_dragon_party faction-monster 6 1
            (pgroup-mk 'dragon "1")
            ))

(define dragon-party-l7
  (ptype-mk "Îµ¤ÈÆ¶·¢¥´¥Ö¥ê¥ó" s_dragon_party faction-monster 7 1
            (pgroup-mk 'dragon "1")
...
(define dragon-party-l8
  (ptype-mk "Îµ¤Î·²¤ì" s_dragon_party faction-monster 8 1
            (pgroup-mk 'dragon "1d3")
            ))

(define gint-party-l4
  (ptype-mk "µð¿Í¤ÎÄå»¡¼Ô" s_gint_party faction-gint 4 5
...
(define accursed-party-l6
  (ptype-mk "¼ö¤ï¤ì¤¿¾åµéÆ³»Õ" s_wizard faction-accursed 6 2
            (pgroup-mk 'accursed-master "1")
            (pgroup-mk 'accursed-defender "1d2")
            (pgroup-mk 'accursed-templar "1d2")
            ))
(define militia-party-l4
  (ptype-mk "Ã¦ÁöÈÉ" s_guard faction-outlaw  4 4
