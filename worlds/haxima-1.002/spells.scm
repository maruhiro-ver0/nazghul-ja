...
(mk-spell 'an_zu            "³ÐÀÃ <An Zu>"                      an-zu            "AZ"   1 context-any   s_an_zu            (list garlic ginseng))
...
(mk-spell 'wis_sanct        "æ«ÃµÃÎ <Wis Sanct>"                wis-sanct        "WS"   1 context-town  s_wis_sanct        (list sulphorous_ash))
(mk-spell 'an_sanct_ylem    "æ«²ò½ü <An Sanct Ylem>"            an-sanct-ylem    "ASY"  1 context-town  s_an_sanct_ylem    (list blood_moss))
...
(mk-spell 'in_bet_xen       "Ãî¾¤´Ô <In Bet Xen>"               in-bet-xen       "IBX"  2 context-town  s_in_bet_xen       (list spider_silk blood_moss sulphorous_ash))
(mk-spell 'rel_hur          "É÷ÊÑ²½ <Rel Hur>"                  rel-hur          "RH"   2 context-any   s_rel_hur          (list sulphorous_ash blood_moss))
...
(mk-spell 'bet_flam_hur     "²ÐÌ¸ <Bet Flam Hur>"               bet-flam-hur     "BFH"  2 context-town  s_bet_flam_hur     (list black_pearl sulphorous_ash blood_moss))
(mk-spell 'in_quas_wis      "ÀéÎ¤´ã <In Quas Wis>"              in-quas-wis      "IQW"  2 context-any   s_in_quas_wis      (list nightshade mandrake))
(mk-spell 'xen_zu           "ºÅÌ² <Xen Zu>"                     xen-zu           "XZ"   2 context-town  s_in_zu            (list spider_silk ginseng))
...
(mk-spell 'in_nox_grav      "ÆÇ¾ì <In Nox Grav>"                in-nox-grav      "ING"  3 context-town  s_in_nox_grav      (list nightshade black_pearl spider_silk))
(mk-spell 'in_zu_grav       "ºÅÌ²¾ì <In Zu Grav>"               in-zu-grav       "IZG"  3 context-town  s_in_zu_grav       (list ginseng black_pearl spider_silk))
...
(mk-spell 'in_flam_sanct    "ÂÑ²Ð <In Flam Sanct>"              in-flam-sanct    "IFS"  3 context-any   s_in_flam_sanct    (list garlic sulphorous_ash t_royal_cape))
(mk-spell 'vas_an_nox       "Á´²òÆÇ <Vas An Nox>"               vas-an-nox       "VAN"  3 context-any   s_vas_an_nox       (list mandrake garlic ginseng))
(mk-spell 'an_ort_xen       "Ã¦ËâË¡ <An Ort Xen>"               an-ort-xen       "AOX"  3 context-any   s_in_an            (list garlic mandrake sulphorous_ash))

;; Fourth Circle
(mk-spell 'an_grav          "Ã¦ËâË¡¾ì <An Grav>"                an-grav          "AG"   4 context-any   s_an_grav          (list black_pearl sulphorous_ash))
...
(mk-spell 'in_sanct         "ÊÝ¸î <In Sanct>"                   in-sanct         "IS"   4 context-any   s_in_sanct         (list sulphorous_ash ginseng garlic))
...
(mk-spell 'in_zu            "Á´ºÅÌ² <In Zu>"                    in-zu            "IZ"   5 context-town  s_in_zu            (list nightshade spider_silk ginseng))
(mk-spell 'vas_mani         "Âç²óÉü <Vas Mani>"                 vas-mani         "VM"   5 context-any   s_vas_mani         (list mandrake spider_silk ginseng))
(mk-spell 'rel_tym          "¹âÂ®²½ <Rel Tym>"                  rel-tym          "RT"   5 context-any   s_rel_tym          (list sulphorous_ash blood_moss mandrake))
...
(mk-spell 'an_xen_ex        "Ì¥Î» <An Xen Ex>"                  an-xen-ex        "AXE"  6 context-town  s_an_xen_ex        (list black_pearl nightshade spider_silk))
...
(mk-spell 'in_zu_hur        "ºÅÌ²É÷ <In Zu Hur>"                in-zu-hur        "IZH"  7 context-town  s_in_zu_hur        (list mandrake ginseng blood_moss))
(mk-spell 'in_quas_corp     "¶²ÉÝ <In Quas Corp>"               in-quas-corp     "IQC"  7 context-town  s_in_quas_corp     (list nightshade mandrake garlic))
(mk-spell 'sanct_lor        "ÉÔ²Ä»ë <Sanct Lor>"                sanct-lor        "SL"   7 context-any   s_sanct_lor        (list nightshade mandrake blood_moss))
...
(mk-spell 'kal_xen_corp     "ÉÔ»à¾¤´Ô <Kal Xen Corp>"           kal-xen-corp     "KXC"  8 context-town  s_kal_xen_corp     (list spider_silk mandrake nightshade))
